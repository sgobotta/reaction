...
// Deprecated methods
const deprecatedCartTransform = {
  cartCount() {
    Logger.warn("this method has been deprecated and is now replaced by the getCount method");
  },
  cartShipping() {
    Logger.warn("this method has been deprecated and is now replaced by the getShipping method");
  },
  cartSubTotal() {
    Logger.warn("this method has been deprecated and is now replaced by the getSubtotal method");
  },
  cartTaxes() {
    Logger.warn("this method has been deprecated and is now replaced by the getTax method");
  },
  cartDiscounts() {
...
export const cartOrderTransform = Object.assign({}, transform, deprecatedCartTransform);
